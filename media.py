...
class Video():
    ...
    def __init__(self, title, duration):
		...
		It initializes a instance of Video type with attributes like video's title and duration.
		"""
		#instance variables
		self.title = title
...
class Movie(Video):
    ...
    def __init__(self, title, duration, story_line, poster_image_url, trailer_youtube_url):
		...
		It initializes a instance of Movie type with movie's title, duration, story line, poster image url and trailer youtube url.
        """
		# instance variables
    ...
    # instance method, which would open the browser and launch a instance's trailer
